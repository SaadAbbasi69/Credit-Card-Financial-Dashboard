...
-- i. copy cc_detail table
COPY cc_detail
FROM 'D:\credit_card.csv' 
DELIMITER ',' 
CSV HEADER;

-- ii. copy cust_detail table
COPY cust_detail
FROM 'D:\customer.csv' 
DELIMITER ',' 
CSV HEADER;
...
-- i. copy additional data (week-53) in cc_detail table
COPY cc_detail
FROM 'D:\cc_add.csv' 
DELIMITER ',' 
CSV HEADER;

-- ii. copy additional data (week-53) in cust_detail table (remember to update the file name and file location in below query)
COPY cust_detail
FROM 'D:\cust_add.csv' 
DELIMITER ',' 
CSV HEADER;
